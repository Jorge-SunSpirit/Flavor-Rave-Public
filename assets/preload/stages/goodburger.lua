...
function changeBillboards()
	runHaxeCode([[
		var ads:Array<String> = ['BasicScreen', 'BasicScreen2', 'BasicScreen3', 'Firecorgur', 'GloopoGulp', 'GrandsSlam', 'MachinesSalad', 'DrinksOnMe', 'Sause', 'SmoothieInsanity', 'Bellameal', 'OCChowdown'];
...
function spawnDork(bool)
	...
	runHaxeCode([[
		var charas:Array<String> = ['CarrotPea', 'MrThrowdown', 'Richard', 'Savory', 'SundriedSynthetic', 'Sutazu', 'Sven', 'tbdtan', 'koolguykyle'];
