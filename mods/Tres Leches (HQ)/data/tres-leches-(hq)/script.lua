...
function onCreate()
	setProperty('countdownSuffix', '_HQ');
	...
	-- the gang
	makeAnimatedLuaSprite('clones', 'corianda/savory_clones_siiva', -25, -450);
	...
	runHaxeCode([[
		game.insert(game.members.indexOf(game.getLuaObject('RoadRave')) + 1, game.getLuaObject('clones'));
	]]);
end
