...
function thingie(num)
	num = tonumber(num)
	--This is temporary. Do not keep this. We will be using callonLua event. FUCK I FORGOT 4-6-2025
	--UTAH
	--WE ARE FINALLY DOING IT 5-29-2025 - jor
	if num == 1 then
		if not middlescroll then --Yeah this works man totally. - I'm mad it did work 5-29-2025
