function onCreate()
	...
	makeAnimatedLuaSprite('doodlebg', 'stages/superfan-extras/doodle-bg', posX, posY);
	addAnimationByPrefix('doodlebg', 'idle', 'BG', 24, true);
	playAnim('doodlebg', 'idle');
	scaleObject('doodlebg', scale, scale);
	addLuaSprite('doodlebg', false);
	setProperty('doodlebg.alpha', 0.0001);
	setScrollFactor('doodlebg', 1, 1);
