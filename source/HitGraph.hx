...
class HitGraph extends Sprite
{
	...
	public var minValue:Float = -(Conductor.safeZoneOffset + 95);
	public var maxValue:Float = Conductor.safeZoneOffset + 95;
	...
	public function new(X:Int, Y:Int, Width:Int, Height:Int)
	{
		...
		early.text = "Early (" + -ClientPrefs.shitWindow + "ms)";
		late.text = "Late (" + ClientPrefs.shitWindow + "ms)";
	...
	function drawJudgementLine(ms:Float):Void
	{
		...
		if (ms == ClientPrefs.marvelousWindow)
	...
	function drawGraph():Void
	{
		...
		drawJudgementLine(ClientPrefs.marvelousWindow);
		gfx.endFill();

		gfx.beginFill(0x00FFFF);
		drawJudgementLine(ClientPrefs.sickWindow);
		gfx.endFill();

		gfx.beginFill(0x00FF00);
		drawJudgementLine(ClientPrefs.goodWindow);
		gfx.endFill();

		gfx.beginFill(0xFF0000);
		drawJudgementLine(ClientPrefs.badWindow);
		gfx.endFill();

		gfx.beginFill(0x8B0000);
		drawJudgementLine(ClientPrefs.shitWindow);
		gfx.endFill();
	...
	{
		return (x / (FlxG.sound.music.length / PlayState.instance.playbackRate)) * width;
	}
