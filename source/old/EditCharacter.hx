...
// This is a version of Character.hx from the first commit of this repo
// modified slightly to not give compile errors.
// Used solely for the Character Editor state
class EditCharacter extends FlxSprite
{
	...
	public function playAnim(AnimName:String, Force:Bool = false, Reversed:Bool = false, Frame:Int = 0):Void
	{
		...
		{
			// trace(['Such alt animation doesnt exist: ' + AnimName]);
