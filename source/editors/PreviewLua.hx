...
class PreviewLua {
	...
	#if hscript
	public static var hscript:FunkinLua.HScript = null;
	#end
	...
	public function new(script:String) {
		...
		try{
			...
			if(resultStr != null && result != 0) {
				...
				#if windows
				FlxG.stage.application.window.alert(resultStr, 'Error on lua script!');
				#else
		...
		// Song/Week shit
		set('curStage', StagePreviewState.curStage);
		...
		set('defaultBoyfriendX', StagePreviewState.instance.BF_X);
		set('defaultBoyfriendY', StagePreviewState.instance.BF_Y);
		set('defaultOpponentX', StagePreviewState.instance.DAD_X);
		set('defaultOpponentY', StagePreviewState.instance.DAD_Y);
		set('defaultGirlfriendX', StagePreviewState.instance.GF_X);
		set('defaultGirlfriendY', StagePreviewState.instance.GF_Y);
		set('defaultExtraCharX', StagePreviewState.instance.EXTRA_X);
		set('defaultExtraCharY', StagePreviewState.instance.EXTRA_Y);
		...
		//set('judgementCounter', ClientPrefs.judgementCounter);
		set('scoreZoom', ClientPrefs.scoreZoom);
		set('cameraZoomOnBeat', true);
		...
		set('debugBuild', #if FORCE_DEBUG_VERSION true #else false #end);
		...
		Lua_helper.add_callback(lua, "setSpriteShader", function(obj:String, shader:String) {
			...
			#if (!flash && MODS_ALLOWED && sys)
			if(!StagePreviewState.instance.runtimeShaders.exists(shader) && !initLuaShader(shader))
			{
			...
			if(leObj != null) {
				var arr:Array<String> = StagePreviewState.instance.runtimeShaders.get(shader);
		...
		Lua_helper.add_callback(lua, "getRunningScripts", function(){
			...
			for (idx in 0...StagePreviewState.instance.luaArray.length)
				runningScripts.push(StagePreviewState.instance.luaArray[idx].scriptName);
		...
		Lua_helper.add_callback(lua, "callOnLuas", function(?funcName:String, ?args:Array<Dynamic>, ignoreStops=false, ignoreSelf=true, ?exclusions:Array<String>){
			...
			StagePreviewState.instance.callOnLuas(funcName, args, ignoreStops, exclusions);
		});
		...
		Lua_helper.add_callback(lua, "callScript", function(?luaFile:String, ?funcName:String, ?args:Array<Dynamic>){
			...
			if(doPush)
			{
				for (luaInstance in StagePreviewState.instance.luaArray)
				{
		...
		Lua_helper.add_callback(lua, "addLuaScript", function(luaFile:String, ?ignoreAlreadyRunning:Bool = false) { //would be dope asf.
			...
			if(doPush)
			{
				...
				StagePreviewState.instance.luaArray.push(new PreviewLua(cervix));
				return;
			}
					...
					for (luaInstance in StagePreviewState.instance.luaArray)
					{
						if(luaInstance.scriptName == cervix)
						{
							//luaTrace('The script "' + cervix + '" is already running!');
								...
								StagePreviewState.instance.luaArray.remove(luaInstance);
							return;
						}
					}
				}
		...
		Lua_helper.add_callback(lua, "doTweenX", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
			...
			if(penisExam != null) {
				StagePreviewState.instance.modchartTweens.set(tag, FlxTween.tween(penisExam, {x: value}, duration, {ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween) {
						StagePreviewState.instance.callOnLuas('onTweenCompleted', [tag]);
						StagePreviewState.instance.modchartTweens.remove(tag);
					}
				}));
			} else {
		...
		Lua_helper.add_callback(lua, "doTweenY", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
			var penisExam:Dynamic = tweenShit(tag, vars);
			if(penisExam != null) {
				StagePreviewState.instance.modchartTweens.set(tag, FlxTween.tween(penisExam, {y: value}, duration, {ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween) {
						StagePreviewState.instance.callOnLuas('onTweenCompleted', [tag]);
						StagePreviewState.instance.modchartTweens.remove(tag);
					}
		...
		Lua_helper.add_callback(lua, "doTweenAngle", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
			var penisExam:Dynamic = tweenShit(tag, vars);
			if(penisExam != null) {
				StagePreviewState.instance.modchartTweens.set(tag, FlxTween.tween(penisExam, {angle: value}, duration, {ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween) {
						StagePreviewState.instance.callOnLuas('onTweenCompleted', [tag]);
						StagePreviewState.instance.modchartTweens.remove(tag);
					}
		...
		Lua_helper.add_callback(lua, "doTweenAlpha", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
			var penisExam:Dynamic = tweenShit(tag, vars);
			if(penisExam != null) {
				StagePreviewState.instance.modchartTweens.set(tag, FlxTween.tween(penisExam, {alpha: value}, duration, {ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween) {
						StagePreviewState.instance.callOnLuas('onTweenCompleted', [tag]);
						StagePreviewState.instance.modchartTweens.remove(tag);
					}
		...
		Lua_helper.add_callback(lua, "doTweenZoom", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
			var penisExam:Dynamic = tweenShit(tag, vars);
			if(penisExam != null) {
				StagePreviewState.instance.modchartTweens.set(tag, FlxTween.tween(penisExam, {zoom: value}, duration, {ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween) {
						StagePreviewState.instance.callOnLuas('onTweenCompleted', [tag]);
						StagePreviewState.instance.modchartTweens.remove(tag);
					}
		...
		Lua_helper.add_callback(lua, "doTweenColor", function(tag:String, vars:String, targetColor:String, duration:Float, ease:String) {
			var penisExam:Dynamic = tweenShit(tag, vars);
			if(penisExam != null) {
				var color:FlxColor = CoolUtil.colorFromString(targetColor);

				var curColor:FlxColor = penisExam.color;
				curColor.alphaFloat = penisExam.alpha;
				StagePreviewState.instance.modchartTweens.set(tag, FlxTween.color(penisExam, duration, curColor, color, {ease: getFlxEaseByString(ease),
					onComplete: function(twn:FlxTween) {
						StagePreviewState.instance.modchartTweens.remove(tag);
						StagePreviewState.instance.callOnLuas('onTweenCompleted', [tag]);
					}
		...
		Lua_helper.add_callback(lua, "runTimer", function(tag:String, time:Float = 1, loops:Int = 1) {
			cancelTimer(tag);
			StagePreviewState.instance.modchartTimers.set(tag, new FlxTimer().start(time, function(tmr:FlxTimer) {
				if(tmr.finished) {
					StagePreviewState.instance.modchartTimers.remove(tag);
				}
				StagePreviewState.instance.callOnLuas('onTimerCompleted', [tag, tmr.loops, tmr.loopsLeft]);
		...
		Lua_helper.add_callback(lua, "keyJustPressed", function(name:String) {
			var key:Bool = false;
			switch(name) {
				case 'left': key = StagePreviewState.instance.getControl('NOTE_LEFT_P');
				case 'down': key = StagePreviewState.instance.getControl('NOTE_DOWN_P');
				case 'up': key = StagePreviewState.instance.getControl('NOTE_UP_P');
				case 'right': key = StagePreviewState.instance.getControl('NOTE_RIGHT_P');
				case 'accept': key = StagePreviewState.instance.getControl('ACCEPT');
				case 'back': key = StagePreviewState.instance.getControl('BACK');
				case 'pause': key = StagePreviewState.instance.getControl('PAUSE');
				case 'reset': key = StagePreviewState.instance.getControl('RESET');
		...
		Lua_helper.add_callback(lua, "keyPressed", function(name:String) {
			var key:Bool = false;
			switch(name) {
				case 'left': key = StagePreviewState.instance.getControl('NOTE_LEFT');
				case 'down': key = StagePreviewState.instance.getControl('NOTE_DOWN');
				case 'up': key = StagePreviewState.instance.getControl('NOTE_UP');
				case 'right': key = StagePreviewState.instance.getControl('NOTE_RIGHT');
		...
		Lua_helper.add_callback(lua, "keyReleased", function(name:String) {
			var key:Bool = false;
			switch(name) {
				case 'left': key = StagePreviewState.instance.getControl('NOTE_LEFT_R');
				case 'down': key = StagePreviewState.instance.getControl('NOTE_DOWN_R');
				case 'up': key = StagePreviewState.instance.getControl('NOTE_UP_R');
				case 'right': key = StagePreviewState.instance.getControl('NOTE_RIGHT_R');
		...
		Lua_helper.add_callback(lua, "precacheSound", function(name:String, ?async:Bool = false) {
			Paths.sound(name, async);
		});
		...
		Lua_helper.add_callback(lua, "getCharacterX", function(type:String) {
			switch(type.toLowerCase()) {
				case 'dad' | 'opponent':
					return StagePreviewState.instance.dadGroup.x;
				case 'gf' | 'girlfriend':
					return StagePreviewState.instance.gfGroup.x;
				case 'extra' | 'extrachar':
					return StagePreviewState.instance.extraGroup.x;
				default:
					return StagePreviewState.instance.boyfriendGroup.x;
			}
		});
		Lua_helper.add_callback(lua, "setCharacterX", function(type:String, value:Float) {
			switch(type.toLowerCase()) {
				case 'dad' | 'opponent':
					StagePreviewState.instance.dadGroup.x = value;
				case 'gf' | 'girlfriend':
					StagePreviewState.instance.gfGroup.x = value;
				case 'extra' | 'extrachar':
					StagePreviewState.instance.extraGroup.x = value;
				default:
					StagePreviewState.instance.boyfriendGroup.x = value;
			}
		});
		Lua_helper.add_callback(lua, "getCharacterY", function(type:String) {
			switch(type.toLowerCase()) {
				case 'dad' | 'opponent':
					return StagePreviewState.instance.dadGroup.y;
				case 'gf' | 'girlfriend':
					return StagePreviewState.instance.gfGroup.y;
				case 'extra' | 'extrachar':
					return StagePreviewState.instance.extraGroup.y;
				default:
					return StagePreviewState.instance.boyfriendGroup.y;
			}
		});
		Lua_helper.add_callback(lua, "setCharacterY", function(type:String, value:Float) {
			switch(type.toLowerCase()) {
				case 'dad' | 'opponent':
					StagePreviewState.instance.dadGroup.y = value;
				case 'gf' | 'girlfriend':
					StagePreviewState.instance.gfGroup.y = value;
				case 'extra' | 'extrachar':
					StagePreviewState.instance.extraGroup.y = value;
				default:
					StagePreviewState.instance.boyfriendGroup.y = value;
			}
		});
		...
		Lua_helper.add_callback(lua, "characterDance", function(character:String) {
			switch(character.toLowerCase()) {
				case 'dad': StagePreviewState.instance.dad.dance();
				case 'gf' | 'girlfriend': if(StagePreviewState.instance.gf != null) StagePreviewState.instance.gf.dance();
				case 'extra' | 'extrachar': if(StagePreviewState.instance.extraChar != null) StagePreviewState.instance.extraChar.dance();
				default: StagePreviewState.instance.boyfriend.dance();
			}
		});
		...
		Lua_helper.add_callback(lua, "makeLuaSprite", function(tag:String, image:String, x:Float, y:Float) {
			tag = tag.replace('.', '');
			resetSpriteTag(tag);
			var leSprite:FunkinLua.ModchartSprite = new FunkinLua.ModchartSprite(x, y);
			if(image != null && image.length > 0)
			{
				leSprite.loadGraphic(Paths.image(image));
			}
			leSprite.antialiasing = ClientPrefs.globalAntialiasing;
			StagePreviewState.instance.modchartSprites.set(tag, leSprite);
		...
		Lua_helper.add_callback(lua, "makeGraphic", function(obj:String, width:Int, height:Int, color:String) {
			...
			var spr:FlxSprite = StagePreviewState.instance.getLuaObject(obj,false);
			if(spr!=null) {
				StagePreviewState.instance.getLuaObject(obj,false).makeGraphic(width, height, colorNum);
				return;
			}
		...
		Lua_helper.add_callback(lua, "addAnimationByPrefix", function(obj:String, name:String, prefix:String, framerate:Int = 24, loop:Bool = true) {
			if(StagePreviewState.instance.getLuaObject(obj,false)!=null) {
				var cock:FlxSprite = StagePreviewState.instance.getLuaObject(obj,false);
		...
		{
			if(StagePreviewState.instance.getLuaObject(obj, false) != null) {
				var luaObj:FlxSprite = StagePreviewState.instance.getLuaObject(obj,false);
				if(luaObj.animation.getByName(name) != null)
				{
					luaObj.animation.play(name, forced, reverse, startFrame);
					if(Std.isOfType(luaObj, FunkinLua.ModchartSprite))
					{
						//convert luaObj to ModchartSprite
						var obj:Dynamic = luaObj;
						var luaObj:FunkinLua.ModchartSprite = obj;
		...
		Lua_helper.add_callback(lua, "finishAnim", function(obj:String)
		{
			if(StagePreviewState.instance.getLuaObject(obj, false) != null) {
				var luaObj:FlxSprite = StagePreviewState.instance.getLuaObject(obj,false);
				luaObj.animation.finish();
				return true;
			}
		...
		Lua_helper.add_callback(lua, "addOffset", function(obj:String, anim:String, x:Float, y:Float) {
			if(StagePreviewState.instance.modchartSprites.exists(obj)) {
				StagePreviewState.instance.modchartSprites.get(obj).animOffsets.set(anim, [x, y]);
				return true;
			}
		...
		Lua_helper.add_callback(lua, "setScrollFactor", function(obj:String, scrollX:Float, scrollY:Float) {
			if(StagePreviewState.instance.getLuaObject(obj,false)!=null) {
				StagePreviewState.instance.getLuaObject(obj,false).scrollFactor.set(scrollX, scrollY);
				return;
			}
		...
		Lua_helper.add_callback(lua, "addLuaSprite", function(tag:String, front:Bool = false) {
			if(StagePreviewState.instance.modchartSprites.exists(tag)) {
				var shit:FunkinLua.ModchartSprite = StagePreviewState.instance.modchartSprites.get(tag);
				if(!shit.wasAdded) {
					if(front)
					{
					...
					{
						var position:Int = StagePreviewState.instance.members.indexOf(StagePreviewState.instance.gfGroup);
						if(StagePreviewState.instance.members.indexOf(StagePreviewState.instance.boyfriendGroup) < position) {
							position = StagePreviewState.instance.members.indexOf(StagePreviewState.instance.boyfriendGroup);
						} else if(StagePreviewState.instance.members.indexOf(StagePreviewState.instance.dadGroup) < position) {
							position = StagePreviewState.instance.members.indexOf(StagePreviewState.instance.dadGroup);
						}
						StagePreviewState.instance.insert(position, shit);
					}
					shit.wasAdded = true;
		...
		Lua_helper.add_callback(lua, "setGraphicSize", function(obj:String, x:Int, y:Int = 0, updateHitbox:Bool = true) {
			if(StagePreviewState.instance.getLuaObject(obj)!=null) {
				var shit:FlxSprite = StagePreviewState.instance.getLuaObject(obj);
		...
		Lua_helper.add_callback(lua, "removeLuaSprite", function(tag:String, destroy:Bool = true) {
			...
			var pee:FunkinLua.ModchartSprite = StagePreviewState.instance.modchartSprites.get(tag);
			if(destroy) {
				pee.kill();
			}
			...
			if(destroy) {
				pee.destroy();
				StagePreviewState.instance.modchartSprites.remove(tag);
			}
		});

		Lua_helper.add_callback(lua, "luaSpriteExists", function(tag:String) {
			return StagePreviewState.instance.modchartSprites.exists(tag);
		});
		Lua_helper.add_callback(lua, "luaTextExists", function(tag:String) {
			return StagePreviewState.instance.modchartTexts.exists(tag);
		});
		Lua_helper.add_callback(lua, "luaSoundExists", function(tag:String) {
			return StagePreviewState.instance.modchartSounds.exists(tag);
		});

		Lua_helper.add_callback(lua, "setObjectCamera", function(obj:String, camera:String = '') {
			/*if(StagePreviewState.instance.modchartSprites.exists(obj)) {
				StagePreviewState.instance.modchartSprites.get(obj).cameras = [cameraFromString(camera)];
				return true;
			}
			else if(StagePreviewState.instance.modchartTexts.exists(obj)) {
				StagePreviewState.instance.modchartTexts.get(obj).cameras = [cameraFromString(camera)];
				return true;
			}*/
			var real = StagePreviewState.instance.getLuaObject(obj);
			if(real!=null){
		...
		Lua_helper.add_callback(lua, "screenCenter", function(obj:String, pos:String = 'xy') {
			var spr:FlxSprite = StagePreviewState.instance.getLuaObject(obj);
		...
		Lua_helper.add_callback(lua, "objectsOverlap", function(obj1:String, obj2:String) {
			...
			{
				var real = StagePreviewState.instance.getLuaObject(namesArray[i]);
				if(real!=null) {
		...
		Lua_helper.add_callback(lua, "playSound", function(sound:String, volume:Float = 1, ?tag:String = null) {
			if(tag != null && tag.length > 0) {
				tag = tag.replace('.', '');
				if(StagePreviewState.instance.modchartSounds.exists(tag)) {
					StagePreviewState.instance.modchartSounds.get(tag).stop();
				}
				StagePreviewState.instance.modchartSounds.set(tag, FlxG.sound.play(Paths.sound(sound), volume, false, function() {
					StagePreviewState.instance.modchartSounds.remove(tag);
					StagePreviewState.instance.callOnLuas('onSoundFinished', [tag]);
				}));
				return;
			}
		...
		Lua_helper.add_callback(lua, "stopSound", function(tag:String) {
			if(tag != null && tag.length > 1 && StagePreviewState.instance.modchartSounds.exists(tag)) {
				StagePreviewState.instance.modchartSounds.get(tag).stop();
				StagePreviewState.instance.modchartSounds.remove(tag);
			}
		});
		Lua_helper.add_callback(lua, "pauseSound", function(tag:String) {
			if(tag != null && tag.length > 1 && StagePreviewState.instance.modchartSounds.exists(tag)) {
				StagePreviewState.instance.modchartSounds.get(tag).pause();
			}
		});
		Lua_helper.add_callback(lua, "resumeSound", function(tag:String) {
			if(tag != null && tag.length > 1 && StagePreviewState.instance.modchartSounds.exists(tag)) {
				StagePreviewState.instance.modchartSounds.get(tag).play();
			}
		});
		Lua_helper.add_callback(lua, "soundFadeIn", function(tag:String, duration:Float, fromValue:Float = 0, toValue:Float = 1) {
			...
			} else if(StagePreviewState.instance.modchartSounds.exists(tag)) {
				StagePreviewState.instance.modchartSounds.get(tag).fadeIn(duration, fromValue, toValue);
			}
		...
		Lua_helper.add_callback(lua, "soundFadeOut", function(tag:String, duration:Float, toValue:Float = 0) {
			if(tag == null || tag.length < 1) {
				...
				StagePreviewState.instance.modchartSounds.get(tag).fadeOut(duration, toValue);
			}
		});
		Lua_helper.add_callback(lua, "soundFadeCancel", function(tag:String) {
			if(tag == null || tag.length < 1) {
				...
				var theSound:FlxSound = StagePreviewState.instance.modchartSounds.get(tag);
		...
		Lua_helper.add_callback(lua, "getSoundVolume", function(tag:String) {
			if(tag == null || tag.length < 1) {
				...
				return StagePreviewState.instance.modchartSounds.get(tag).volume;
			}
			return 0;
		});
		Lua_helper.add_callback(lua, "setSoundVolume", function(tag:String, value:Float) {
			if(tag == null || tag.length < 1) {
				...
				StagePreviewState.instance.modchartSounds.get(tag).volume = value;
			}
		});
		Lua_helper.add_callback(lua, "getSoundTime", function(tag:String) {
			if(tag != null && tag.length > 0 && StagePreviewState.instance.modchartSounds.exists(tag)) {
				return StagePreviewState.instance.modchartSounds.get(tag).time;
			}
			return 0;
		});
		...
		Lua_helper.add_callback(lua, "makeLuaText", function(tag:String, text:String, width:Int, x:Float, y:Float) {
			tag = tag.replace('.', '');
			resetTextTag(tag);
			var leText:FunkinLua.ModchartText = new FunkinLua.ModchartText(x, y, text, width);
			StagePreviewState.instance.modchartTexts.set(tag, leText);
		});
		...
		Lua_helper.add_callback(lua, "addLuaText", function(tag:String) {
			if(StagePreviewState.instance.modchartTexts.exists(tag)) {
				var shit:FunkinLua.ModchartText = StagePreviewState.instance.modchartTexts.get(tag);
				if(!shit.wasAdded) {
					getInstance().add(shit);
					shit.wasAdded = true;
					//trace('added a thing: ' + tag);
		...
		Lua_helper.add_callback(lua, "removeLuaText", function(tag:String, destroy:Bool = true) {
			...
			var pee:FunkinLua.ModchartText = StagePreviewState.instance.modchartTexts.get(tag);
			if(destroy) {
				pee.kill();
			}
			...
			if(destroy) {
				pee.destroy();
				StagePreviewState.instance.modchartTexts.remove(tag);
			}
		});

		Lua_helper.add_callback(lua, "initSaveData", function(name:String, ?folder:String = 'psychenginemods') {
			if(!StagePreviewState.instance.modchartSaves.exists(name))
			{
				var save:FlxSave = new FlxSave();
				save.bind(name, CoolUtil.getSavePath(folder));
				StagePreviewState.instance.modchartSaves.set(name, save);
				return;
			}
		...
		Lua_helper.add_callback(lua, "flushSaveData", function(name:String) {
			if(StagePreviewState.instance.modchartSaves.exists(name))
			{
				StagePreviewState.instance.modchartSaves.get(name).flush();
				return;
			}
		...
		Lua_helper.add_callback(lua, "getDataFromSave", function(name:String, field:String, ?defaultValue:Dynamic = null) {
			if(StagePreviewState.instance.modchartSaves.exists(name))
			{
				var retVal:Dynamic = Reflect.field(StagePreviewState.instance.modchartSaves.get(name).data, field);
				return retVal;
			}
		...
		Lua_helper.add_callback(lua, "setDataFromSave", function(name:String, field:String, value:Dynamic) {
			if(StagePreviewState.instance.modchartSaves.exists(name))
			{
				Reflect.setField(StagePreviewState.instance.modchartSaves.get(name).data, field, value);
				return;
			}
		...
		Lua_helper.add_callback(lua, "objectPlayAnimation", function(obj:String, name:String, forced:Bool = false, ?startFrame:Int = 0) {
			...
			if(StagePreviewState.instance.getLuaObject(obj,false) != null) {
				StagePreviewState.instance.getLuaObject(obj,false).animation.play(name, forced, false, startFrame);
				return true;
			}
		...
		Lua_helper.add_callback(lua, "characterPlayAnim", function(character:String, anim:String, ?forced:Bool = false) {
			...
			switch(character.toLowerCase()) {
				case 'dad':
					if(StagePreviewState.instance.dad.animOffsets.exists(anim))
						StagePreviewState.instance.dad.playAnim(anim, forced);
				case 'gf' | 'girlfriend':
					if(StagePreviewState.instance.gf != null && StagePreviewState.instance.gf.animOffsets.exists(anim))
						StagePreviewState.instance.gf.playAnim(anim, forced);
				case 'extra' | 'extrachar':
					if(StagePreviewState.instance.extraChar != null && StagePreviewState.instance.extraChar.animOffsets.exists(anim))
						StagePreviewState.instance.extraChar.playAnim(anim, forced);
				default:
					if(StagePreviewState.instance.boyfriend.animOffsets.exists(anim))
						StagePreviewState.instance.boyfriend.playAnim(anim, forced);
			}
		});
		Lua_helper.add_callback(lua, "luaSpriteMakeGraphic", function(tag:String, width:Int, height:Int, color:String) {
			...
			if(StagePreviewState.instance.modchartSprites.exists(tag)) {
				...
				StagePreviewState.instance.modchartSprites.get(tag).makeGraphic(width, height, colorNum);
			}
		});
		Lua_helper.add_callback(lua, "luaSpriteAddAnimationByPrefix", function(tag:String, name:String, prefix:String, framerate:Int = 24, loop:Bool = true) {
			...
			if(StagePreviewState.instance.modchartSprites.exists(tag)) {
				var cock:FunkinLua.ModchartSprite = StagePreviewState.instance.modchartSprites.get(tag);
				cock.animation.addByPrefix(name, prefix, framerate, loop);
				if(cock.animation.curAnim == null) {
					cock.animation.play(name, true);
				}
		...
		Lua_helper.add_callback(lua, "luaSpriteAddAnimationByIndices", function(tag:String, name:String, prefix:String, indices:String, framerate:Int = 24) {
			...
			if(StagePreviewState.instance.modchartSprites.exists(tag)) {
				...
				var pussy:FunkinLua.ModchartSprite = StagePreviewState.instance.modchartSprites.get(tag);
		...
		Lua_helper.add_callback(lua, "luaSpritePlayAnimation", function(tag:String, name:String, forced:Bool = false) {
			...
			if(StagePreviewState.instance.modchartSprites.exists(tag)) {
				StagePreviewState.instance.modchartSprites.get(tag).animation.play(name, forced);
			}
		});
		Lua_helper.add_callback(lua, "setLuaSpriteCamera", function(tag:String, camera:String = '') {
			...
			if(StagePreviewState.instance.modchartSprites.exists(tag)) {
				StagePreviewState.instance.modchartSprites.get(tag).cameras = [cameraFromString(camera)];
				return true;
			}
		...
		Lua_helper.add_callback(lua, "setLuaSpriteScrollFactor", function(tag:String, scrollX:Float, scrollY:Float) {
			...
			if(StagePreviewState.instance.modchartSprites.exists(tag)) {
				StagePreviewState.instance.modchartSprites.get(tag).scrollFactor.set(scrollX, scrollY);
				return true;
			}
			return false;
		});
		...
		Lua_helper.add_callback(lua, "getPropertyLuaSprite", function(tag:String, variable:String) {
			...
			if(StagePreviewState.instance.modchartSprites.exists(tag)) {
				var killMe:Array<String> = variable.split('.');
				if(killMe.length > 1) {
					var coverMeInPiss:Dynamic = Reflect.getProperty(StagePreviewState.instance.modchartSprites.get(tag), killMe[0]);
					for (i in 1...killMe.length-1) {
						coverMeInPiss = Reflect.getProperty(coverMeInPiss, killMe[i]);
					}
					return Reflect.getProperty(coverMeInPiss, killMe[killMe.length-1]);
				}
				return Reflect.getProperty(StagePreviewState.instance.modchartSprites.get(tag), variable);
			}
			return null;
		});
		Lua_helper.add_callback(lua, "setPropertyLuaSprite", function(tag:String, variable:String, value:Dynamic) {
			...
			if(StagePreviewState.instance.modchartSprites.exists(tag)) {
				...
				Reflect.setProperty(StagePreviewState.instance.modchartSprites.get(tag), variable, value);
				return true;
			}
	...
	public function initHaxeModule()
	{
		if(hscript == null)
		{
			...
			hscript = new FunkinLua.HScript(); //TO DO: Fix issue with 2 scripts not being able to use the same variable names
		}
	}
	#end
	...
	public static function setVarInArray(instance:Dynamic, variable:String, value:Dynamic):Any
	{
		...
		if(shit.length > 1)
		{
			...
			if(StagePreviewState.instance.variables.exists(shit[0]))
			{
				var retVal:Dynamic = StagePreviewState.instance.variables.get(shit[0]);
				if(retVal != null)
					blah = retVal;
			}
			else
		...
		if(StagePreviewState.instance.variables.exists(variable))
		{
			StagePreviewState.instance.variables.set(variable, value);
			return true;
		}
	...
	public static function getVarInArray(instance:Dynamic, variable:String):Any
	{
		...
		if(StagePreviewState.instance.variables.exists(variable))
		{
			var retVal:Dynamic = StagePreviewState.instance.variables.get(variable);
			if(retVal != null)
				return retVal;
		}
	...
	{
		return StagePreviewState.instance.modchartTexts.exists(name) ? StagePreviewState.instance.modchartTexts.get(name) : Reflect.getProperty(StagePreviewState.instance, name);
	}
	...
	function initLuaShader(name:String, ?glslVersion:Int = 120)
	{
		...
		#if (!flash && sys)
		if(StagePreviewState.instance.runtimeShaders.exists(name))
		{
		...
		for (folder in foldersToCheck)
		{
			if(FileSystem.exists(folder))
			{
				...
				if(found)
				{
					StagePreviewState.instance.runtimeShaders.set(name, [frag, vert]);
	...
	function resetTextTag(tag:String) {
		...
		pee.kill();
		if(pee.wasAdded) {
			StagePreviewState.instance.remove(pee, true);
		}
		pee.destroy();
		StagePreviewState.instance.modchartTexts.remove(tag);
	}
	...
	function cancelTween(tag:String) {
		if(StagePreviewState.instance.modchartTweens.exists(tag)) {
			StagePreviewState.instance.modchartTweens.get(tag).cancel();
			StagePreviewState.instance.modchartTweens.get(tag).destroy();
			StagePreviewState.instance.modchartTweens.remove(tag);
		}
	}
	...
	function cancelTimer(tag:String) {
		if(StagePreviewState.instance.modchartTimers.exists(tag)) {
			var theTimer:FlxTimer = StagePreviewState.instance.modchartTimers.get(tag);
			theTimer.cancel();
			theTimer.destroy();
			StagePreviewState.instance.modchartTimers.remove(tag);
		}
	...
	function cameraFromString(cam:String):FlxCamera {
		switch(cam.toLowerCase()) {
			case 'camhud' | 'hud' | 'cameffect' | 'effect' | 'camother' | 'other': return StagePreviewState.instance.camHUD;
		}
		return StagePreviewState.instance.camGame;
	}
	...
	public function luaTrace(text:String, ignoreCheck:Bool = false, deprecated:Bool = false, color:FlxColor = FlxColor.WHITE) {
		...
		if(ignoreCheck || getBool('luaDebugMode')) {
			...
			StagePreviewState.instance.addTextToDebug(text, color);
			trace(text);
		}
		#end
	}
	...
	static function addAnimByIndices(obj:String, name:String, prefix:String, indices:String, framerate:Int = 24, loop:Bool = false)
	{
		...
		if(StagePreviewState.instance.getLuaObject(obj, false)!=null) {
			var pussy:FlxSprite = StagePreviewState.instance.getLuaObject(obj, false);
	...
	{
		var coverMeInPiss:Dynamic = StagePreviewState.instance.getLuaObject(objectName, checkForTextsToo);
	...
	{
		return StagePreviewState.instance;
	}
}
